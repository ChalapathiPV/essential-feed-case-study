...
class RemoteFeedLoaderTests: XCTest {
    ...
    func test_load_deliverNoItemsOn200HTTPREponseWithEmptyJsonList() {
        let (sut, client)  = makeSUT()
    ...
    func test_load_deliverItemsOn200HTTPTResponseJSONItems() {
        let (sut, client) = makeSUT()
        ...
        expect(sut, toCompleteWith: .success(items), when: {
            ...
            let json = makeItems(items: [item1.json, item2.json])
    ...
    private func makeItems(items: [[String: Any]]) -> Data {
